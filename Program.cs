    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            try {
                ...
                // Se il compleanno nell'anno corrente è già passato, valutiamo quello dell'anno successivo
                if (dataProssimoCompleanno < DateTime.Today) dataProssimoCompleanno = new DateTime(DateTime.Today.Year + 1, dataDiNascita.Month, dataDiNascita.Day);
